create or replace external table ET_PC_WCTRANSACTION(
	...
	AMOUNT FLOAT AS (CAST(GET($1, 'Amount') AS FLOAT)),
	WCCOST NUMBER(38,0) AS (TO_NUMBER(GET($1, 'WCCost'))),
	...
	AMOUNTBILLING FLOAT AS (CAST(GET($1, 'AmountBilling') AS FLOAT)),
