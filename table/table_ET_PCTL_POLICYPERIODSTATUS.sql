create or replace external table ET_PCTL_POLICYPERIODSTATUS(
	LASTMODIFIED VARCHAR(16777216) AS (SUBSTR(METADATA$FILENAME, 29, 23)),
...
location=@CSVLOADING/
auto_refresh=false
pattern='.*dbo_PCTL_POLICYPERIODSTATUS_.*'
