create or replace external table ET_PC_IMTRANSACTION(
	...
	WRITTEN NUMBER(38,0) AS (TO_NUMBER(GET($1, 'Written'))),
	AMOUNT NUMBER(38,0) AS (TO_NUMBER(GET($1, 'Amount'))),
	...
	AMOUNTBILLING NUMBER(38,0) AS (TO_NUMBER(GET($1, 'AmountBilling'))),
	...
	TOBEACCRUED NUMBER(38,0) AS (TO_NUMBER(GET($1, 'ToBeAccrued'))),
	...
	CHARGED NUMBER(38,0) AS (TO_NUMBER(GET($1, 'Charged'))),
	IMCOST NUMBER(38,0) AS (TO_NUMBER(GET($1, 'IMCost'))),
	BRANCHID NUMBER(38,0) AS (TO_NUMBER(GET($1, 'BranchID'))))
location=@CSVLOADING/
auto_refresh=false
pattern='.*dbo_PC_IMTRANSACTION_.*'
