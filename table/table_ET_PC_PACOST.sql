create or replace external table ET_PC_PACOST(
	...
	STANDARDTERMAMOUNTBILLING_CUR NUMBER(38,0) AS (TO_NUMBER(GET($1, 'StandardTermAmountBilling'))),
	PERSONALVEHICLECOV NUMBER(38,0) AS (TO_NUMBER(GET($1, 'PersonalVehicleCov'))),
	...
	PERSONALAUTOCOV NUMBER(38,0) AS (TO_NUMBER(GET($1, 'PersonalAutoCov'))),
	OVERRIDEADJRATE NUMBER(38,0) AS (TO_NUMBER(GET($1, 'OverrideAdjRate'))),
	...
	PAPIPCOVCOSTTYPE NUMBER(38,0) AS (TO_NUMBER(GET($1, 'PAPIPCovCostType'))),
	...
	PERSONALAUTOLINE NUMBER(38,0) AS (TO_NUMBER(GET($1, 'PersonalAutoLine'))),
	...
	PERSONALVEHICLE NUMBER(38,0) AS (TO_NUMBER(GET($1, 'PersonalVehicle'))),
