create or replace external table ET_PCTL_PRIMARYPHONETYPE(
	LASTMODIFIED VARCHAR(16777216) AS (SUBSTR(METADATA$FILENAME, 21, 23)),
...
location=@CSVLOADING/
auto_refresh=false
pattern='.*dbo_PCTL_PRIMARYPHONETYPE_.*'
